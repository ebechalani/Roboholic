...
export const MICROBIT_COURSE: Course = {
  ...
  duration: `${6 + MICROBIT_UNIT_LESSON_COUNT + MICROBIT_CHAPTER_LESSONS.length + MICROBIT_EXTRA_LESSONS.length + MICROBIT_CREATEAI_LESSONS.length} sessions × 45–60 minutes`,
  totalHours: 6 + MICROBIT_UNIT_LESSON_COUNT + MICROBIT_CHAPTER_LESSONS.length + MICROBIT_EXTRA_LESSONS.length + MICROBIT_CREATEAI_LESSONS.length,
  lessonCount: 6 + MICROBIT_UNIT_LESSON_COUNT + MICROBIT_CHAPTER_LESSONS.length + MICROBIT_EXTRA_LESSONS.length + MICROBIT_CREATEAI_LESSONS.length,
  prerequisites: [],
