...
import { CHESS_COURSE, CHESS_LESSONS } from './chess';
import { CS_UNPLUGGED_COURSE, CS_UNPLUGGED_LESSONS } from './cs-unplugged';
...
import { VEX_VR_COURSE, VEX_VR_LESSONS } from './vex-vr';
...
export const ALL_LESSONS: Record<string, LessonDetail> = {
  ...
  ...Object.fromEntries(CHESS_LESSONS.map(l => [l.id, l])),
  ...Object.fromEntries(CS_UNPLUGGED_LESSONS.map(l => [l.id, l])),
  ...
  ...Object.fromEntries(VEX_VR_LESSONS.map(l => [l.id, l])),
...
export const COURSES_BY_PROGRAM: Record<string, Course> = {
  ...
  [CHESS_COURSE.programSlug]: CHESS_COURSE,
  [CS_UNPLUGGED_COURSE.programSlug]: CS_UNPLUGGED_COURSE,
  [TELLO_COURSE.programSlug]: TELLO_COURSE,
  [GAME_DESIGN_COURSE.programSlug]: GAME_DESIGN_COURSE,
  [VR_COURSE.programSlug]: VR_COURSE,
  [VEX_VR_COURSE.programSlug]: VEX_VR_COURSE,
...
export const ALL_COURSES: Course[] = [ESM_COURSE, WEDO_COURSE, SCRATCH_JR_COURSE, CODEY_COURSE, MBOT2_COURSE, EV3_COURSE, ARDUINO_COURSE, TINKERCAD_COURSE, MICROBIT_COURSE, MTINY_COURSE, SMALLBASIC_COURSE, PYTHON_COURSE, SPIKE_COURSE, ELECTRONICS_COURSE, AI_ML_COURSE, MAKEY_COURSE, TELLO_COURSE, GAME_DESIGN_COURSE, VR_COURSE, VEX_VR_COURSE, PRINTING_3D_COURSE, SCRATCH_COURSE, WEBDEV_COURSE, PHP_COURSE, PROJECTS_COURSE, MAKEX_COURSE, COMPETITION_COURSE, INVENTION_COURSE, CHESS_COURSE, CS_UNPLUGGED_COURSE];
